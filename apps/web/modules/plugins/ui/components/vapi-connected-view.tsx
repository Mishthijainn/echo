...
import { VapiPhoneNumbersTab } from "./vapi-phone-numbers-tabs"
    ...
    return(
        <div className="spacr-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="flex size-12 items-center justify-center rounded-lg border bg-muted">
                                <SettingsIcon className=" size-6 text-muted-foreground"></SettingsIcon>
                            </div>
                            <div>
            ...
            <div className="overflow-hidden rounded-lg border bg-background">
                ...
                value={activeTab}
                >
                    <TabsList className="grid h-12 w-full grid-cols-2 p-8">
                    ...
                    <TabsContent value="phone-numbers">
                        <VapiPhoneNumbersTab></VapiPhoneNumbersTab>
                    </TabsContent>
                    <TabsContent value="assistants">
                        <VapiAssistantsTab></VapiAssistantsTab>
                    </TabsContent>
                </Tabs>
            </div>
        </div>
