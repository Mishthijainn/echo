...
export const ConversationIdView=({
    ...
    if(conversation===undefined ||messages.status==="LoadingFirstPage" ){
        return <ConversationIdViewLoading></ConversationIdViewLoading>
    }
    return(
        <div className="flex h-full flex-col bg-muted">
            <header className="flex items-center justify-between border-b bg-background p-2.5">
                ...
                {conversation && (<ConversationStatusButton
                 onClick={handleToggleStatus} status={conversation.status} disabled={isUpdatingStatus}></ConversationStatusButton>)}
            </header>
            ...
            <AIConversationScrollButton></AIConversationScrollButton>
            </AIConversation>
            <div className="p-2">
                <Form {...form}>
                    <AIInput onSubmit={form.handleSubmit(onSubmit)}>
                        <FormField control={form.control} disabled={conversation?.status==="resolved"} name="message" render={({field})=>(
                            ...
                            } onChange={field.onChange} onKeyDown={(e)=>{
                        ...
                        <AIInputToolbar>
                            ...
                            } status="ready" type="submit"></AIInputSubmit>
                        </AIInputToolbar>
                    </AIInput>
                </Form>
...
export const ConversationIdViewLoading=()=>{
    return(
        <div className="flex h-full flex-col bg-muted">
            ...
            <AIConversation className="max-h-[calc(100vh-100px)]">
                <AIConversationContent>
                    {Array.from({length:8},(_,index)=>{
                        ...
                        return(
                            ...
                            key={index}>
                                <Skeleton className={`h-9 ${width} rounded-lg bg-neutral-200`}></Skeleton>
                                <Skeleton className="size-8 rounded-full bg-neutral-200"></Skeleton>
                            </div>
                        )
                    })}
                </AIConversationContent>
            ...
            <div className="p-2">
                <AIInput>
                    <AIInputTextarea disabled placeholder="Type your response as an operator"></AIInputTextarea>
                    <AIInputToolbar>
                        <AIInputTools></AIInputTools>
                        <AIInputSubmit disabled status="ready"></AIInputSubmit>
                    </AIInputToolbar>
                </AIInput>
