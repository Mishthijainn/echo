        ...
        <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea {...field} placeholder="Welcome message shown when chat open" rows={3}></Textarea>
                                </FormControl>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="mb-4 text-muted-foreground text-sm">
                                    Quick reply suggestions shown to customer to help guide the conversation
                                </p>
                                <div className="space-y-4">
                                    <FormField
                        control={form.control}
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...field} placeholder="e.g., How do I get Started?"></Input>
                                </FormControl>
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...field} placeholder="e.g., What are your pricing plans"></Input>
                                </FormControl>
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input {...field} placeholder="e.g., I need help with my account"></Input>
                                </FormControl>
                ...
                {hasVapiPlugin &&(
                    ...
                    <CardContent className="space-y-6">
                        <VapiFormFields form={form}></VapiFormFields>
                    </CardContent>
                    </Card>
